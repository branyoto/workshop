  ...
  return (
    <div className="flex flex-1 flex-col gap-2 p-3">
      <div className="flex items-start justify-between gap-2 text-start">
        <span className="text-sm font-medium text-primary-900">{l(item.title)}</span>
      ...
      <div className="mt-auto flex items-center justify-between gap-2">
        <span className="text-sm font-semibold text-primary-900">{formatPrice(item.price)}</span>
        {item.available && (
